...
export default function ContactForm() {
    ...
    return (
        <section className="w-full min-h-screen scroll-mt-18" id="contact">
            <div className="container mx-auto flex flex-center h-[800px] box-padding">
                {/* Map Section */}
                <div className="w-full h-[800px] lg:h-full rounded-lg overflow-hidden">
                    <iframe

                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3005.570148482691!2d20.788352999999997!3d41.122077999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1350ddc3f47712ad%3A0xaca35a94b5aff550!2sAgo%20Dizel%20BOSCH%20DIESEL%20SERVICE!5e0!3m2!1str!2smk!4v1747945298059!5m2!1str!2smk"
