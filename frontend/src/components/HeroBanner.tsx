    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold max-w-4xl mb-4 sm:mb-6 font-slab lg:leading-[1.2]">
                ALBANIA DİZEL – Güvenilir Bosch Dizel Servisi Uzmanınız
            </h1>

            {/* Subheading */}
            <p className="max-w-3xl mb-6 sm:mb-8 text-gray-700 text-base sm:text-lg">
                Bosch yetkili dizel servisidir. Dizel enjektör ve pompa sistemlerinde uzmanız. Kaliteli, hızlı ve garantili hizmet anlayışıyla çalışıyoruz.
            </p>
            ...
            >
                <a href="#services" className="inline-block bg-accent text-white px-6 sm:px-8 py-3 rounded-lg btn-transition hover:bg-accent/90 cursor-pointer">
