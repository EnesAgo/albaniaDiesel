        ...
        >
            ...
            >
                ...
                <h3 className="text-3xl md:text-4xl font-bold mb-6 font-slab">
                    Bosch Diesel servisimize hoşgeldiniz
                </h3>
                <p className="text-gray-600 mb-8">
                    Dizel enjektör ve pompa onarımı konusunda Bosch yetkili servisidir. Son teknoloji test ekipmanları ve uzman kadrosuyla hızlı ve güvenilir hizmet sunar. Aracınızın performansını en üst düzeye çıkarmak için buradayız.
                </p>
